...
\begin{tabular}{P{0.36\linewidth} P{0.52\linewidth} P{0.08\linewidth}}
\toprule
...
\begin{tabular}{P{0.44\linewidth} P{0.44\linewidth} P{0.08\linewidth}}
\toprule
\textbf{Column} & \textbf{Meaning (concise)} & \textbf{Unit}\\
\midrule
...
\begin{tabular}{P{0.40\linewidth} P{0.42\linewidth} P{0.14\linewidth}}
\toprule
...
\begin{tabular}{P{0.40\linewidth} P{0.42\linewidth} P{0.12\linewidth}}
\toprule
...
\begin{tabular}{P{0.46\linewidth} P{0.40\linewidth} P{0.10\linewidth}}
\toprule
\textbf{Column} & \textbf{Meaning (concise)} & \textbf{Unit}\\
\midrule
...
\begin{tabular}{P{0.38\linewidth} P{0.48\linewidth} P{0.10\linewidth}}
\toprule
\textbf{Base name} & \textbf{Meaning (concise)} & \textbf{Unit}\\
\midrule
...
\begin{tabular}{P{0.18\linewidth} P{0.66\linewidth} P{0.10\linewidth}}
\toprule
