...
\begin{tabular}{P{0.36\linewidth} P{0.38\linewidth} P{0.18\linewidth}}
\toprule
...
\begin{tabular}{P{0.42\linewidth} P{0.42\linewidth} P{0.10\linewidth}}
\toprule
\textbf{Column} & \textbf{Meaning (concise)} & \textbf{Unit}\\
\midrule
...
\begin{tabular}{P{0.36\linewidth} P{0.46\linewidth} P{0.10\linewidth}}
\toprule
\textbf{Base name} & \textbf{Meaning (concise)} & \textbf{Unit}\\
\midrule
...
\begin{tabular}{P{0.16\linewidth} P{0.66\linewidth} P{0.10\linewidth}}
\toprule
